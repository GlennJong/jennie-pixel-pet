...
import { petStatusWording, idleActionsWording, actionsWording, templates } from "./config.constants";
...
const ConfigEditor = ({ onChange } : { onChange: () => void }): JSX.Element => {
  ...
  return (
    <div style={{ position: 'relative', padding: '32px 0', minWidth: '400px', boxSizing: 'border-box', maxHeight: '100vh', overflow: 'auto' }}>
      ...
      <JsonEditor
        title="自動動作：復活"
        wording={actionsWording}
        hide={['animationSet', 'action', 'user', 'portrait', 'auto', 'effect', 'status']}
      ...
      <JsonEditor
        title="購買：Lv1"
        wording={actionsWording}
        hide={['animationSet', 'action', 'user', 'portrait', 'auto', 'condition', 'level']}
